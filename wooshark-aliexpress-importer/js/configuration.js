(function (jQuery) {
    ...
    function getProductCountDraft() {
      jQuery.ajax({
        ...
        data: { 
          ...
          action: "sharkDropship-getProductsCountDraft-alibay" },
        success: function (e) {
          let t = e;
    ...
    function getProductsCount() {
      jQuery.ajax({
        ...
        data: { 
          nonce: wooshark_params.nonce,
          action: "sharkDropship-getProductsCount-alibay" },
        success: function (e) {
    ...
    function getCategories(e) {
      jQuery.ajax({
        ...
        data: { 
          nonce: wooshark_params.nonce,
          action: "sharkDropship-get_categories-alibay" },
        success: function (t) {
      ...
      startLoading(),
        jQuery.ajax({
          ...
          data: {
            ...
            nonce: wooshark_params.nonce,
            action: "sharkDropship-insert-reviews-to-productRM-alibay",
            post_id: t,
            reviews: e
          },
          success: function (e) {
  ...
  <div class="modal-content"
      ...
      if (variationsSet.length > 0) {
        jQuery.ajax({
          ...
          data: {
            ...
            nonce: wooshark_params.nonce,
            action: "sharkDropship-theShark-alibay-insertVariations",
      ...
      tagsProduct && tagsProduct.length && (g = tagsProduct),
        ...
        jQuery.ajax({
          ...
          data: {
            ...
            nonce: wooshark_params.nonce,
            action: "sharkDropship-wooshark-insert-product-alibay",
    ...
    function restoreConfiguration() {
      ...
      jQuery.ajax({
        ...
        data: { 
          nonce: wooshark_params.nonce,
          action: "sharkDropship-restoreConfiguration-alibay" },
        success: function (t) {
          let a, r, i, o, n;
        ...
        //   displayToast("save price markup formula"),
          jQuery.ajax({
            ...
            data: {
              ...
              nonce: wooshark_params.nonce,
              action: "sharkDropship-saveOptionsDB-alibay",
      ...
      e &&
        (startLoading(),
          jQuery.ajax({
            ...
            data: { 
              nonce: wooshark_params.nonce,
              action: "sharkDropship-remove-product-from-wp-alibay", post_id: e },
            success: function (e) {
              e && e.error && e.error_msg && displayToast(e.error_msg, "red"),
                e && !e.error && e.data && displayToast(e.data, "green");
            },
    ...
    function getAlreadyImportedProducts(e) {
      jQuery.ajax({
        ...
        data: { 
          nonce: wooshark_params.nonce,
          action: "sharkDropship-get-already-imported-products-alibay", listOfSkus: e },
        success: function (e) {
          let t = e;
        ...
        t &&
          jQuery.ajax({
            ...
            data: {
              ...
              nonce: wooshark_params.nonce,
              action: "sharkDropship-search-category-by-name-alibay",
    ...
    function insertProductAsAffiliate(e) {
      ...
      h = {
        ...
        data: {
          ...
          nonce: wooshark_params.nonce,
          action: "sharkDropship-theShark_alibay_insertProductInWoocommerceAffiliate",
    ...
    jQuery(document).on("click", "#searchBySku", function (e) {
      ...
      t
        ? jQuery.ajax({
          ...
          data: { 
            nonce: wooshark_params.nonce,
            action: "sharkDropship-search-product-by-sku-alibay", searchSkuValue: t },
          success: function (response) {
    ...
    function getAllProducts(page) {
      ...
      jQuery.ajax({
        ...
        data: {
          ...
          nonce: wooshark_params.nonce,
          action: 'sharkDropship-get_products-alibay',
    ...
    function loadProductsByType(productType, page) {
      ...
      jQuery.ajax({
        ...
        data: {
          ...
          nonce: wooshark_params.nonce,
          action: 'sharkDropship-get_products_by_type_alibay', // Use the appropriate backend action
    ...
    function loadAllProductsAliExpress(page) {
      ...
      jQuery.ajax({
        ...
        data: {
          ...
          nonce: wooshark_params.nonce,
          action: 'sharkDropship-get_aliexpress_products_alibay',
          page: page, // Change page number as needed
        },
        success: function (response) {
    ...
    function loadAllProductsEbay(page) {
      ...
      jQuery.ajax({
        ...
        data: {
          ...
          nonce: wooshark_params.nonce,
          action: 'sharkDropship-get_aliexpress_products_alibay_ebay',
          page: page, // Change page number as needed
        },
        success: function (response) {
    ...
    function loadAllProductsAmazon(page) {
      ...
      jQuery.ajax({
        ...
        data: {
          ...
          nonce: wooshark_params.nonce,
          action: 'sharkDropship-get_aliexpress_products_alibay_amazon',
          page: page, // Change page number as needed
        },
        success: function (response) {
