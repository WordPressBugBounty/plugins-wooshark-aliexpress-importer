(function (jQuery) {
    ...
    //         type: "POST",
    //         dataType: "JSON",
    //         data: { action: "sharkDropship-getProductsCount-alibay" },
    //         success: function (e) {
    ...
    function displayCommonDetailsForVariableProducts(productId) {
        ...
        jQuery.ajax({
            ...
            data: {
                ...
                action: 'sharkDropship-load_woocommerce_variations_alibay', // Add an action to handle loading WooCommerce variations
  ...
  <div style="dislay:flex; margin-top:10px">
    ...
    jQuery(document).on("click", ".delete-product", function (e) {
        ...
        jQuery.ajax({
            ...
            data: {
                ...
                action: 'sharkDropship-delete_product_callback_alibay',
                product_id: productId
            },
            success: function (response) {
    ...
    jQuery(document).on("click", ".set-to-draft", function (e) {
        ...
        jQuery.ajax({
            ...
            data: {
                ...
                action: 'sharkDropship-set_product_to_draft_callback_alibay',
                product_id: productId
            },
            success: function (response) {
    ...
    jQuery(document).on('click', '#confirmUpdate', function () {
        ...
        jQuery.ajax({
            ...
            data: {
                ...
                action: 'sharkDropship-update_variations_on_woocommerce_alibay',
    ...
    //         dataType: 'json',
    //         data: {
    //             action: 'sharkDropship-fetchemote_alibay', // WordPress AJAX action name,
    //             url: url
    //         },
    //         success: function (response) {
    //             if (response.success) {
      ...
      <div class="modal-footer">
        ...
        jQuery('#saveUrlButton').off('click').on('click', function () {
            ...
            jQuery.ajax({
                ...
                data: { 
                    nonce: wooshark_params.nonce,
                    action: "sharkDropship-updateProductUrlAlibay", productUrl: jQuery('#newProductUrl').val(), product_id: product_id },
                success: function (e) {
